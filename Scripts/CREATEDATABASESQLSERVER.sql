...
-- Agregar rangos por artículo a tabla de cabecera de inventario, F50C.
-- Agregar tabla de rangos de inventario, F50R.
-- AVC - 16.09.2009, 21.09.2009 - NC7
...
CREATE TABLE F14C001 (
       ...
       F14CFECFAB           datetime NULL,
       F14CFECCAL           datetime NULL,
...
CREATE TABLE F16C001 (
       ...
       F16CFECFAB           datetime NULL,
       F16CFECENT           datetime NULL,
...
CREATE TABLE F18C001 (
       ...
       F18CFECPED           datetime NOT NULL,
       F18CFECPRE           datetime NULL,
       F18CFECCIE           datetime NULL,
...
CREATE TABLE F20C001 (
       ...
       F20CFECFAB           datetime NULL,
       F20CFECCAL           datetime NULL,
       ...
       F20CFECENV           datetime NULL,
       F20CNUMENV           numeric(7) NULL,
       F20CFECORD           datetime NULL,
...
CREATE TABLE F24C001 (
       ...
       F24CFECDOC           datetime NOT NULL,
       F24CDIRASO           char(13) NULL,
       F24CNUMPED           varchar(15) NULL,
       F24CFECPRE           datetime NULL,
...
CREATE TABLE F24L001 (
       ...
       F24LFECDOC           datetime NOT NULL,
       F24LFECPRE           datetime NULL,
...
CREATE TABLE F26C001 (
       ...
       F26CFECCRE           datetime NOT NULL,
       F26CFPRMOV           datetime NULL,
       F26CFULMOV           datetime NULL,
...
CREATE TABLE F26L001 (
       ...
       F26LFECFAB           datetime NULL,
       F26LFECCAL           datetime NULL,
...
CREATE TABLE F27C001 (
       ...
       F27CFECALB           datetime NOT NULL,
       F27CFECEMB           datetime NULL,
...
CREATE TABLE F27L001 (
       ...
       F27LFECTRP           datetime NULL,
       F27LHORTRP           char(8) NULL,
       F27LNUMREL           numeric(5) NULL,
       F27LFECREL           datetime NULL,
...
CREATE TABLE F30C001 (
       ...
       F30CFECALB           datetime NOT NULL,
       F30CFECEMB           datetime NULL,
       ...
       F30CFECLLE           datetime NULL,
       F30CCODSIT           char(1) NOT NULL,
       F30CFECENT           datetime NULL,
       ...
       F30CFECEMI           datetime NULL,
       F30CNUMTRP           numeric(5) NOT NULL,
       F30CFECTRP           datetime NULL,
       F30CHORTRP           varchar(8) NULL,
       F30CFECCFE           datetime NULL,
...
CREATE TABLE F36D001 (
       ...
       F36DFECCAL           datetime NOT NULL,			-- Fecha cálculo
...
CREATE TABLE F36P001 (
       ...
       F36PFECENT           datetime NOT NULL,
       F36PFECSAL           datetime NOT NULL,
       F36PFECVAL           datetime NOT NULL,
...
CREATE TABLE F38C001 (
       ...
       F38CFECDES           datetime NOT NULL,
       F38CFECHAS           datetime NOT NULL,
...
CREATE TABLE F50C001 (
       ...
       F50CFECCRE           datetime NOT NULL,
       F50CFECINI           datetime NULL,
       F50CFECFIN           datetime NULL,
       F50CUBIINI           char(14) NOT NULL,
       F50CUBIDSD           char(14) NOT NULL,
	 F50CARTDSD		    char(13), NOT NULL,
	 F50CARTHST		    char(13), NOT NULL,
...
CREATE TABLE F50R001 (
	F50RNUMINV char (6) NOT NULL,
	F50RCODPRO char (6) NOT NULL,
	F50RCODART char (13) NOT NULL,
	F50RESTADO char (1) NOT NULL
)
go

ALTER TABLE F50R001
       ADD PRIMARY KEY (F50RNUMINV, F50RCODPRO, F50RCODART)
go
...
CREATE TABLE F70C001 (
       ...
       F70CFECCAL           datetime NOT NULL,
       F70CNUMFAC           char(10) NOT NULL,
       F70CFECFAC           datetime NOT NULL,
       F70CFECCIE           datetime NULL,
       F70CFCHINI           datetime NULL,
       F70CFCHFIN           datetime NULL,
